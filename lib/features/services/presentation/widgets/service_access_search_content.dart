...
ServiceAccessSearchConfig serviceAccessSearchConfigFromTitle(String serviceTitle) {
  if (serviceTitle == 'Cari Dokter') {
    return const ServiceAccessSearchConfig(
      ...
      emptyDescription: 'Masukkan nama dokter, spesialis, atau fasilitas kesehatan untuk mulai mencari.',
  ...
  return const ServiceAccessSearchConfig(
    ...
    emptyDescription: 'Masukkan nama fasilitas, jenis fasilitas, atau alamat untuk mulai mencari.',
    categoryField: 'type',
    searchFields: [
      'type',
      'name',
...
const List<Map<String, dynamic>> serviceAccessMockFacilities = [
...
List<Map<String, dynamic>> getServiceAccessMockItems(ServiceAccessSearchType type) {
  switch (type) {
    ...
    case ServiceAccessSearchType.healthFacility:
      return serviceAccessMockFacilities;
  }
}
...
class _ServiceAccessSearchContentState extends State<ServiceAccessSearchContent> {
  ...
  List<Map<String, dynamic>> get _filteredItems {
    ...
    return _searchMatchedItems.where((item) {
      return item[_config.categoryField] == _selectedCategory;
    }).toList();
  }
  ...
  int _getCategoryCount(String category) {
    ...
    return _searchMatchedItems.where((item) {
      return item[_config.categoryField] == category;
    }).length;
  }
  ...
  Widget _buildSearchResult(ServiceAccessSearchConfig config) {
  ...
  Widget _buildCategoryList() {
    return FilterChipsRow(
      chips: _categories.map((category) {
